...
from Dataset_2 import Quickdraw414k
...
if __name__ == '__main__':
    ...
    train_loader = torch.utils.data.DataLoader(
        train_data, batch_size=args.batch_size, shuffle=True, num_workers=1, pin_memory=True)

    test_data = Quickdraw414k(mode="Test", augmentation='weak')
    test_loader = torch.utils.data.DataLoader(
        test_data, batch_size=args.test_bs, shuffle=False, num_workers=1, pin_memory=True)
    
    valid_data = Quickdraw414k(mode="Valid", augmentation='weak')
    valid_loader = torch.utils.data.DataLoader(
        valid_data, batch_size=args.test_bs, shuffle=False, num_workers=1, pin_memory=True)
